...
banner() {
    ...
    toilet -f ivrit 'YASH' | boxes -d cat -a hc -p h8 | lolcat
    else
    cowsay 'Navin H' | lolcat
    fi
    echo 'This Bomber Was Created By Devil' | lolcat
    echo 'For Any Queries Contact Me!!!'| lolcat
    echo 'Intagram:- dare_yash'| lolcat
    echo ' '| lolcat
...
if [ -f .update ];then
    ...
    install_deps
    echo 'This Script Was Made By Devil Yash' > .update
...
do
	...
	echo -e "\e[4;34m This Bomber Was Created By Yash \e[0m" | lolcat
	echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
	echo -e "\e[1;32m   Intagram:- dare_yash\e[0m"| lolcat
	echo -e "\e[4;32m   Whatsapp: +919696995592 \e[0m"| lolcat
        exit
    elif [ $ch -eq 0 ];then
        banner
        exit
