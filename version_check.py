...
def verCheck():
    ...
    ver_url = 'https://raw.githubusercontent.com/Devil-Yash/master/Core/version.txt'
    ...
    if ver_sc == 200:
        ...
        if ver_current == github_ver:
            ...
            sleep(2)
            system("git clone https://github.com/Devil-Yash ../TEMP")
            system("cd ..;rm -rf  Devil-Yash;mv TEMP Devil-Yash;cd Devil-Yash;chmod +x *")
